...
const PageWindow: React.FC<windowProps> = ({ isOpen, onClose, zCounter }) => {
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full h-7 bg-gradient-to-b from-blue-400 via-blue-600 via-20% to-blue-700 to-90% flex justify-end items-center gap-1 select-none"
      >
